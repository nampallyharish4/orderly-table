      ...
      <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            variant="outline"
            size="sm"
            className="flex-1 sm:flex-none hover:border-emerald-500/50 hover:text-emerald-400 transition-colors"
          ...
          <Button
            asChild
            className="bg-gradient-primary hover:opacity-90 flex-1 sm:flex-none shadow-lg shadow-primary/20"
            size="sm"
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-2 sm:gap-3">
            <Button
              asChild
              variant="outline"
              className="w-full justify-start h-12 sm:h-14 hover:border-emerald-500/30 hover:bg-emerald-500/5 transition-all duration-200 group"
            >
              <Link to="/tables">
                ...
                <div className="text-left min-w-0">
                  ...
                  <p className="text-[10px] sm:text-xs text-emerald-400/70 truncate">
                    {availableTables} available
                  </p>
                </div>
              </Link>
            ...
            <Button
              asChild
              variant="outline"
              className="w-full justify-start h-12 sm:h-14 hover:border-amber-500/30 hover:bg-amber-500/5 transition-all duration-200 group"
            >
              <Link to="/kitchen">
                ...
                <div className="text-left min-w-0">
                  ...
                  <p className="text-[10px] sm:text-xs text-amber-400/70 truncate">
            ...
            <Button
              asChild
              variant="outline"
              className="w-full justify-start h-12 sm:h-14 col-span-2 lg:col-span-1 hover:border-purple-500/30 hover:bg-purple-500/5 transition-all duration-200 group"
            >
              <Link to="/orders">
                ...
                <div className="text-left min-w-0">
                  ...
                  <p className="text-[10px] sm:text-xs text-purple-400/70 truncate">
