...
export const mockTables: Table[] = [
  ...
  { id: 'table-4', tableNumber: 'T4', capacity: 2, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small' } as Table & { size: string },
  // Row 3: empty, T5
  { id: 'table-placeholder-1', tableNumber: '', capacity: 0, floor: 'Small Tables', status: 'available', currentOrderIds: [], hidden: true } as Table & { hidden: boolean },
  { id: 'table-5', tableNumber: 'T5', capacity: 4, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small' } as Table & { size: string },
  // Row 4: T8, T6 (both small, adjacent)
  { id: 'table-8', tableNumber: 'T8', capacity: 2, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small-left' } as Table & { size: string },
  { id: 'table-6', tableNumber: 'T6', capacity: 4, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small-right' } as Table & { size: string },
  // Row 5: T9, T7 (both small, adjacent)
  { id: 'table-9', tableNumber: 'T9', capacity: 2, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small-left' } as Table & { size: string },
  { id: 'table-7', tableNumber: 'T7', capacity: 4, floor: 'Small Tables', status: 'available', currentOrderIds: [], size: 'small-right' } as Table & { size: string },
  // Other floors
