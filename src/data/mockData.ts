...
export const mockTables: Table[] = [
  ...
  // Row 2: T3 (large), T4 (small, half size)
  ...
  // Row 6: T8, T9
  { id: 'table-8', tableNumber: 'T8', capacity: 2, floor: 'Large Tables', status: 'available', currentOrderIds: [] },
  { id: 'table-9', tableNumber: 'T9', capacity: 2, floor: 'Large Tables', status: 'available', currentOrderIds: [] },
  // Other floors
