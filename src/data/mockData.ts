...
export const mockTables: Table[] = [
  ...
  { id: 'table-2', tableNumber: 'T2', capacity: 2, floor: 'Main', status: 'occupied', currentOrderId: 'order-1' },
  ...
  { id: 'table-5', tableNumber: 'T5', capacity: 6, floor: 'Main', status: 'occupied', currentOrderId: 'order-2' },
  ...
  { id: 'table-8', tableNumber: 'T8', capacity: 8, floor: 'Main', status: 'occupied', currentOrderId: 'order-3' },
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        unitPrice: 34.99,
        totalPrice: 69.98,
        addOns: [{ addOnId: 'addon-5', name: 'Mushroom Sauce', price: 3.50 }],
        status: 'preparing',
        isVeg: false,
      },
    ],
    ...
    items: [
      {
        ...
        unitPrice: 16.99,
        totalPrice: 33.98,
        addOns: [{ addOnId: 'addon-8', name: 'Extra Cheese', price: 2.50 }],
        status: 'ready',
        isVeg: true,
      },
      {
    ...
    items: [
      {
        ...
        unitPrice: 15.99,
        totalPrice: 47.97,
        addOns: [{ addOnId: 'addon-10', name: 'Bacon', price: 2.50 }],
        status: 'pending',
        isVeg: false,
      },
      {
    ...
    items: [
      {
        id: 'oi-7',
        menuItemId: 'item-8',
        menuItemName: 'Pepperoni Supreme',
        quantity: 2,
        unitPrice: 19.99,
        totalPrice: 39.98,
        addOns: [],
    ...
    items: [
      {
        ...
        unitPrice: 14.99,
        totalPrice: 14.99,
        addOns: [{ addOnId: 'addon-12', name: 'Vegan Cheese', price: 1.50 }],
        status: 'ready',
        isVeg: true,
      },
      {
